...
var BilibiliAPI = {
    ...
    DanmuWebSocket: class extends WebSocket {
        ...
        constructor(uid, roomid, serveraddress = 'wss://broadcastlv.chat.bilibili.com/sub',serveraddressList=[]) {
            ...
            this.addEventListener('close', () => {
                ...
                // 自动重连
                setTimeout(() => {
                    let newWsUrl = serveraddress;
                    if(serveraddressList.length > 1){
                        let beforeWsUrl = serveraddress;
                        do{
